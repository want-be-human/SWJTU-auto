...
# -*- coding: utf-8 -*-
"""
硬编码版：专门抢 犀浦 8号羽毛球 19:00-22:00（后天）
在触发前 1 秒持续下单（与之前逻辑一致）
注意：payload 不包含 memberId，orderUseDate 为毫秒整数时间戳
支持同时预约 19:00-20:00、20:00-21:00、21:00-22:00 三个时段
"""
...
PLACE_ID_8 = "1560141364299046912"  # 8号羽毛球 placeId
SPORT_TYPE_ID = "2"  # 羽毛球

# 硬编码的三段 sessionId（后天）
# 顺序建议为 ["19:00-20:00", "20:00-21:00", "21:00-22:00"]，缺失时可留空字符串或删除对应项
SESSION_IDS = [
    "1966169997028892672",  # 19:00-20:00
    "1966169997163110400",  # 20:00-21:00
    "1966169997272162304"   # 21:00-22:00
]
...
# 下单策略：在触发前 0.5 秒开始持续下单
RESERVE_START_DELTA_SECONDS = 0.5    # 在触发时间前多少秒开始下单（0.5秒）
...
if __name__ == "__main__":
    print("脚本启动：将等待并在指定时间尝试抢后天 8号 19:00-22:00 场次（可同时预约多个时段）。")
    main_run_once()
